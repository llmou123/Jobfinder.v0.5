...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull DrawerLayout rootView, @NonNull DrawerLayout drawerLayout,
      @NonNull FrameLayout mainContainer, @NonNull ImageView menuIcon,
      @NonNull NavigationView navView, @NonNull ImageView profileIcon) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((DrawerLayout) rootView, drawerLayout, mainContainer, menuIcon,
          navView, profileIcon);
    }
