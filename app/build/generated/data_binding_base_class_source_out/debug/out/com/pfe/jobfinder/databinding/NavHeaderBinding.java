...
public final class NavHeaderBinding implements ViewBinding {
  ...
  private NavHeaderBinding(@NonNull LinearLayout rootView, @NonNull CircleImageView navUserImage,
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      CircleImageView navUserImage = ViewBindings.findChildViewById(rootView, id);
      if (navUserImage == null) {
        break missingId;
      }

      id = R.id.nav_user_name;
      TextView navUserName = ViewBindings.findChildViewById(rootView, id);
      if (navUserName == null) {
        break missingId;
      }

      return new NavHeaderBinding((LinearLayout) rootView, navUserImage, navUserName);
    }
